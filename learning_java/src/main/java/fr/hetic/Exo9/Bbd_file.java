...
public class Bbd_file {
    ...
    public static void main(String[] args) {
        ...
        Bbd_file reader = (Bbd_file) context.getBean("reader");
        reader.readFiles();
    ...
    private String generateFileContent(Connection connection, int fileId) throws SQLException {
